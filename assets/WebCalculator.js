...
WebCalculator.math.computePerimeter = function(c, i, b, g, a, e, m, d) {
    var l = WebCalculator.math;
    var k = l.computeLineLength(c, i, b, g);
    var j = l.computeLineLength(b, g, a, e);
    var h = selfh.computeLineLength(a, e, m, d);
    var f = l.computeLineLength(m, d, c, i);
    return l.computePerimeterByLength(k, j, h, f)
};
WebCalculator.math.computePerimeterByLength = function(d, c, b, a) {
    return WebCalculator.math.add(d, c, b, a)
};
WebCalculator.math.computePerimeterOfSquare = function(a) {
    return WebCalculator.math.multiply(a, 4)
};
WebCalculator.math.areaOfTriangle = function(b, a) {
    return WebCalculator.math.multiply(b, a, 0.5)
};
WebCalculator.math.areaOfTrapizoid = function(b, f, d) {
    var e = WebCalculator.math;
    var c = e.add(f, d);
    var a = e.divide(c, 2);
    return e.multiply(b, a)
};
WebCalculator.math.average = function() {
    var a = WebCalculator.math;
    var b = a.add(arguments);
    return a.divide(b, arguments.length)
};
WebCalculator.math.areaOfCircle = function(a) {
    var b = WebCalculator.math;
    return b.multiply(b.PI, b.square(a))
};
WebCalculator.math.circumferenceOfACircle = function(a) {
    return WebCalculator.math.multiply(2, WebCalculator.math.PI, a)
};
WebCalculator.math.surfaceAreaCone = function(d, c) {
    var e = WebCalculator.math;
    var b = e.sqrt(e.multiply(e.PI, e.square(d)));
    var a = e.add(e.square(d), e.square(c));
    var f = e.multiply(d, e.PI, a);
    return e.add(b, f)
};
WebCalculator.math.volumeCone = function(b, a) {
    return WebCalculator.math.multiply((1 / 3), WebCalculator.math.PI,
            WebCalculator.math.square(b), a)
};
WebCalculator.math.surfaceAreaCylinder = function(b, a) {
    var c = WebCalculator.math;
    var e = c.multiply(2, c.PI, c.square(b));
    var d = c.multiply(2, c.PI, b, a);
    return c.add(e, d)
};
WebCalculator.math.volumeCylinder = function(b, a) {
    return WebCalculator.math.multiply(WebCalculator.math.PI, WebCalculator.math
            .square(b), a)
};
WebCalculator.math.surfaceAreaSphere = function(a) {
    return WebCalculator.math.multiply(4, WebCalculator.math.PI, WebCalculator.math
            .square(a))
};
WebCalculator.math.volumeSphere = function(a) {
    return WebCalculator.math.multiply((4 / 3), WebCalculator.math.PI,
            WebCalculator.math.cube(a))
};
